...
public class Rocher extends Biome{

	public Rocher(Point position, int tempsDestruction) {
	...
	public Map<Ressources,Integer> detruire(int coefficient) {
		...
		int aleatoireCaillou = rand.nextInt(4);
		int aleatoireMinerai = rand.nextInt(2);
